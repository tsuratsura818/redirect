    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted text-sm mt-1">QRコードの管理状況を確認できます</p>
        </div>
        <Link
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-card rounded-xl border border-border p-6">
          <div className="text-sm text-muted mb-1">登録QRコード</div>
      ...
      <div className="bg-card rounded-xl border border-border">
        <div className="px-6 py-4 border-b border-border">
          <h2 className="font-bold text-foreground">QRコード一覧</h2>
        </div>
        {codes.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-muted mb-4">まだQRコードがありません</p>
            <Link
              href="/dashboard/qr/new"
            ...
            {codes.map(code => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className={`w-3 h-3 rounded-full ${code.is_active ? 'bg-success' : 'bg-gray-300'}`} />
                  <div>
